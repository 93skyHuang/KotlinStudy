...
//        textView.setGravity(Gravity.CENTER);
    ...
    private void setHintString(AppCompatTextView textView, CharSequence textString) {
        textView.setHint(textString);
        if (!TextUtils.isEmpty(textString)) {
            textView.setVisibility(VISIBLE);
        }
    }
    ...
    public void setCenterHintString(CharSequence s) {
        setHintString(centerTextView, s);
    }
