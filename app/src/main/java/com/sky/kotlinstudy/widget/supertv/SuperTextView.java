...
import com.ipcom.iunifi.common.view.supertv.helper.ShapeBuilder;
...
//    private boolean mRightBottomTextBold;
    ...
    private boolean mBottomDividerLineAlignLeftText = true;
...
//        mRightBottomTextBold = typedArray.getBoolean(R.styleable.SuperTextView_sRightBottomTextIsBold, false);
        ...
        mBottomDividerLineAlignLeftText = typedArray.getBoolean(R.styleable.SuperTextView_sBottomDividerLineAlignLeftText, true);
    ...
    private void drawBottomDivider(Canvas canvas) {
        ...
        int marginLeft = mBottomDividerLineMarginLeft;
        if (marginLeft < 0) {
            marginLeft = 0;
        } else {
            if (leftIconRes != null && mBottomDividerLineAlignLeftText) {
                marginLeft = mLeftViewMarginLeft + leftIconMarginLeft + leftIconRes.getMinimumWidth();
            }
        }

        drawDivider(canvas, false, mBottomDividerLineMarginLR, marginLeft, mBottomDividerLineMarginRight, mBottomDividerPaint);
    }
    ...
    private void initSuperTextView() {
        if (useRipple) {
            this.setBackgroundResource(R.drawable.super_selector_white);
...
//        setDefaultTextIsBold(centerView, mCenterTopTextBold, mCenterTextBold, mCenterBottomTextBold);
    ...
    private void initRightTextView() {
        ...
        rightBaseViewParams.addRule(RelativeLayout.RIGHT_OF, R.id.sLeftViewId);
...
//        setDefaultTextIsBold(rightView, mRightTopTextBold, mRightTextBold, mRightBottomTextBold);
        ...
        setHintString(rightView, mRightHintString);
        if (mRightLines == 1) {
            rightView.getCenterTextView().setEllipsize(TextUtils.TruncateAt.END);
        }
        addView(rightView);
    }
     ...
     *
     * @param baseTextView    baseTextView
     * @param rightHintString rightHintString
     */
    private void setHintString(BaseTextView baseTextView, String rightHintString) {
        if (baseTextView != null) {
            baseTextView.setCenterHintString(rightHintString);
        }
    }
    ...
    public void setSLeftTextString(CharSequence string) {
    ...
    public void setSLeftBottomTextString(CharSequence string) {
        setLeftBottomString(string);
    }
